...
def main():
    # Left Part - Text about Semantic Similarity
    st.title("SemanticApp")
    st.text("""
    This App computes the semantic similarity between two texts
    """)

    st.sidebar.title("About Semantic Similarity")
    st.sidebar.write("""
    Semantic similarity between two texts means how much they talk about the same things.
        ...
        if uploaded_file_1 and uploaded_file_2:
            try:
                ...
                if content_1 == content_2:
                    st.warning("The two provided texts are identic. Please reupload different files and try again.")
                else:
                    ...
                    with st.spinner("Calculating the semantic similarity of the two texts..."):
                        ...
                        # Convert the sentences to vector embeddings
                    ...
                    # Display the similarity score with appropriate formatting
                ...
                st.warning("Please reupload different files and try again.")
